...
const ProfileForm = (props) => {
  const { fields: { avatar, username, email }, resetForm, handleSubmit, submitting, parentSubmitting } = props;
  return (
          ...
          <tr>
            ...
            <td>
              <fieldset className={classNames('form-group', { 'has-warning': username.touched && username.error })}>
                <input
                  type="text"
                  className={classNames('form-control', buttonStyles.inputNoRadius, { 'form-control-warning': username.touched && username.error })}
          ...
          <tr>
            ...
            <td>
              <fieldset className={classNames('form-group', { 'has-warning': email.touched && email.error })}>
                <input
                  type="email"
                  className={classNames('form-control', buttonStyles.inputNoRadius, { 'form-control-warning': email.touched && email.error })}
          ...
          <tr>
            ...
            <td>
              <fieldset className="form-group">
                <button
                  type="submit" className={classNames(buttonStyles.primary, buttonStyles.ico_login)}
                ...
                <button
                  ...
                  disabled={submitting || parentSubmitting} onClick={resetForm}
                >
                  Clear Values
                </button>
              </fieldset>
